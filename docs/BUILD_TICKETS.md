...
- [FBMVP-T04: Onboarding / Signup Flow Update](epochs/fbmvp-t04-onboarding-signup-flow-update.md) - aligns signup, login, profile, access-hold, and verification copy with the airline-email eligibility and beta invite-code journey without changing gate rules or creating migrations.
...
- [Work-Email Confirmation Email Flow Implementation](epochs/work-email-confirmation-email-flow-implementation.md) - adds app-generated airline employee email confirmation tokens/email/confirm route so approved-domain work-email requests can become the forward airline-email verified access state after runtime migration apply.
