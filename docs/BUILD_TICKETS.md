...
- [Proof Upload Content Validation Fix](ops/proof-upload-content-validation-fix.md) - pending-runtime security hardening that stops redacted proof upload from trusting browser MIME/extension alone and requires server-side JPEG/PNG byte validation before private Storage upload.
