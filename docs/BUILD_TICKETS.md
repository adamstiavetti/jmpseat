...
- [Waitlist Duplicate Survey Token Fix](ops/waitlist-duplicate-survey-token-fix.md) - security hardening note for preventing anonymous duplicate waitlist submissions from receiving an existing signup's survey token or editing another signup's optional survey answers.
