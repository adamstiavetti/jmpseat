...
| 01 | Public Splash + Waitlist | Active / public domains launched | Make concept publicly viewable and capture waitlist interest. | `APP_FOUNDATION_NOTES.md`, `LANDING_PAGE_WAITLIST_PLAN.md`, `DEPLOYMENT_AND_WAITLIST_READINESS.md`, `ops/post-e05-public-waitlist-launch-plan.md`, `ops/waitlist-question-research-selection.md`, `ops/public-waitlist-page-polish.md`, `ops/waitlist-metrics-dashboard.md`, `ops/public-waitlist-launch-readiness-check.md`, `ops/public-waitlist-root-cutover-runtime-pass.md`, `ops/public-waitlist-www-runtime-pass.md`, `DEPLOYMENT_RECORD_001.md` | Public `jmpseat.com` and `www.jmpseat.com` serve the waitlist page without Beta Access, first-party email capture works, optional product-shaping follow-up works, mobile page reviewed, first-party waitlist metrics captured, authorized admin metrics view exists, and launch metadata/legal surfaces are root-ready. | Apex root cutover is runtime-proven; `www.jmpseat.com` DNS/Vercel alias follow-up is smoke-tested. | Monitor root and `www` waitlist reachability while preserving beta. |
...
- Monitor `www.jmpseat.com` after DNS/Vercel alias follow-up.
